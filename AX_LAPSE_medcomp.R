...
plot(x=1:26, y=c(SZ_med_lapses$N_CueCorr_AX_err))
points(x=1:6, y=c(SZ_unmed_lapses$N_CueCorr_AX_err), col="red")
...
plot(x=1:26, y=c(SZ_med_l_vmpfC$AX_CuCo_PrIn_Cu.AX_CuCo_PrCo_Cu))
points(x=1:6, y=c(SZ_unmed_l_vmpfC$AX_CuCo_PrIn_Cu.AX_CuCo_PrCo_Cu), col="red")
